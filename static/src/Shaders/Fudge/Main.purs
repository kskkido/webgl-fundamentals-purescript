module Shaders.Fudge.Main where
...
import Shaders.Fudge.Models.DrawConfig.Main as DrawConfig
import Shaders.Fudge.Models.Context.Main as Context
import Shaders.Fudge.Models.Env.Main as Env
    ...
    pure
      ( Array.replicate config.count
        ...
        Lib.Array.revolving
          Lib.Matrix.multiply
          ( Foldable.foldl Lib.Matrix.multiply Lib.Matrix4.unit $
            [ Lib.Matrix4.fudge config.fudge
