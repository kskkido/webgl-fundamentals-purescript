module Pages.Shaders.CameraLookAt.Main where
...
import Shaders.CameraLookAt.Models.DrawConfig.Main as Shaders.CameraLookAt.Models.DrawConfig
import Shaders.CameraLookAt.Models.Context.Main as Shaders.CameraLookAt.Models.Context
import Shaders.CameraLookAt.Main as Shaders.CameraLookAt
  ...
  Effect.Aff.launchAff_ do
    result <- ExceptT.runExceptT $ do
      ...
      ExceptT.mapExceptT Effect.Class.liftEffect do
        ...
        context <- Shaders.CameraLookAt.Models.Context.fromEnv
          { canvas: canvas
          }
        ...
        ExceptT.lift $ do
          subscribe <- pure $ ContT.runContT
            ( Lib.PubSub.merge
              ...
              map Shaders.CameraLookAt.Models.DrawConfig.fromMap
            )
          subscribe $ \config -> do
            ...
            result <- ExceptT.runExceptT $ Shaders.CameraLookAt.main config context
