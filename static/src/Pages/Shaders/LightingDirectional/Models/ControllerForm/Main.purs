module Pages.Shaders.LightingDirectional.Models.ControllerForm.Main where
...
fromMap :: Map.Map String Number -> ControllerForm
fromMap mx =
...
toDrawConfig :: Number -> ControllerForm -> DrawConfig.DrawConfig -> DrawConfig.DrawConfig
