module Pages.Shaders.LightingDirectional.Main where
...
import Pages.Shaders.LightingDirectional.Models.ControllerForm.Main as Pages.Shaders.LightingDirectional.Models.ControllerForm
import Shaders.LightingDirectional.Models.DrawConfig.Main as Shaders.LightingDirectional.Models.DrawConfig
import Shaders.LightingDirectional.Models.Context.Main as Shaders.LightingDirectional.Models.Context
import Shaders.LightingDirectional.Main as Shaders.LightingDirectional
  ...
  Effect.Aff.launchAff_ do
    result <- ExceptT.runExceptT $ do
      ...
      ExceptT.mapExceptT Effect.Class.liftEffect do
        ...
        context <- Shaders.LightingDirectional.Models.Context.fromEnv
          { canvas: canvas
          }
        controller <- ExceptT.lift $ do
          angle <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.angle) input
          ...
          radius <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.radius) input
          ...
          count <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.count) input
          ...
          fieldOfView <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.fieldOfView) input
            Web.DOM.Element.setAttribute "step" (show 0.1) input
          ...
          x <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.position.x) input
          ...
          y <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.position.y) input
          ...
          z <- do
            ...
            Web.DOM.Element.setAttribute "value" (show $ Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.position.z) input
          ...
          scaleX <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.scale.x) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          scaleY <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ -2) input
            Web.DOM.Element.setAttribute "max" (show 2) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.scale.y) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          scaleZ <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ -2) input
            Web.DOM.Element.setAttribute "max" (show 2) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.scale.z) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          rotationSpeedX <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.rotationSpeed.x) input
          ...
          rotationSpeedY <- do
            ...
            Web.DOM.Element.setAttribute "min" (show 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.rotationSpeed.y) input
          ...
          rotationSpeedZ <- do
            ...
            Web.DOM.Element.setAttribute "min" (show 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.rotationSpeed.z) input
          ...
          pause <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.pause) input
            Web.DOM.Element.setAttribute "step" (show 1) input
          ...
          lightX <- do
            ...
            Web.DOM.Element.setAttribute "step" (show 0.01) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.rotationSpeed.x) input
            Lib.Element.setTextContent "lightX: " label
            pure $
              { field: field
              , input: input
              , value: value
          ...
          lightY <- do
            ...
            Web.DOM.Element.setAttribute "max" (show 1) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.light.y) input
            Lib.Element.setTextContent "lightY: " label
            pure $
              { field: field
              , input: input
              , value: value
          ...
          lightZ <- do
            ...
            Web.DOM.Element.setAttribute "max" (show 1) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingDirectional.Models.ControllerForm.unit.light.z) input
            Lib.Element.setTextContent "lightZ: " label
            pure $
              { field: field
              , input: input
              , value: value
          ...
          subscribe <- pure $ ContT.runContT $
            ( Lib.PubSub.concat
              ...
              ( Lib.PubSub.merge
                ...
                , ( Lib.PubSub.fromEvent (Web.Event.Event.EventType "input") (Web.DOM.Element.toEventTarget controller.lightX.input) #
                    Lib.PubSub.filterMap Web.Event.Event.target #
                    Lib.PubSub.filterMap Web.HTML.HTMLInputElement.fromEventTarget #
                    Lib.PubSub.bindIO Web.HTML.HTMLInputElement.value #
                    Lib.PubSub.filterMap Number.fromString #
                    map (Tuple.Nested.tuple2 "light.x")
                  )
                , ( Lib.PubSub.fromEvent (Web.Event.Event.EventType "input") (Web.DOM.Element.toEventTarget controller.lightY.input) #
                    Lib.PubSub.filterMap Web.Event.Event.target #
                    Lib.PubSub.filterMap Web.HTML.HTMLInputElement.fromEventTarget #
                    Lib.PubSub.bindIO Web.HTML.HTMLInputElement.value #
                    Lib.PubSub.filterMap Number.fromString #
                    map (Tuple.Nested.tuple2 "light.y")
                  )
                , ( Lib.PubSub.fromEvent (Web.Event.Event.EventType "input") (Web.DOM.Element.toEventTarget controller.lightZ.input) #
                    Lib.PubSub.filterMap Web.Event.Event.target #
                    Lib.PubSub.filterMap Web.HTML.HTMLInputElement.fromEventTarget #
                    Lib.PubSub.bindIO Web.HTML.HTMLInputElement.value #
                    Lib.PubSub.filterMap Number.fromString #
                    map (Tuple.Nested.tuple2 "light.z")
                  )
                ] #
                Lib.PubSub.fold Lib.Map.insert Map.empty #
                map Pages.Shaders.LightingDirectional.Models.ControllerForm.fromMap #
                ( Lib.PubSub.tapIO $ \config -> do
                    ...
                    Lib.Element.setTextContent (show config.light.x) controller.lightX.value
                    Lib.Element.setTextContent (show config.light.y) controller.lightY.value
                    Lib.Element.setTextContent (show config.light.z) controller.lightZ.value
                )
              )
            ) #
            ( Lib.PubSub.filter $ \tx ->
            ...
            ( Lib.PubSub.fold
                ( \tx config ->
                  ( let d = Tuple.Nested.get1 tx
                    ...
                    in Pages.Shaders.LightingDirectional.Models.ControllerForm.toDrawConfig d c config
                  )
                )
                Shaders.LightingDirectional.Models.DrawConfig.unit
            )
          subscribe $ \config -> do
            result <- ExceptT.runExceptT $ Shaders.LightingDirectional.main config context
