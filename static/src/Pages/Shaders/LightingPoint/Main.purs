module Pages.Shaders.LightingPoint.Main where
...
import Pages.Shaders.LightingPoint.Models.ControllerForm.Main as Pages.Shaders.LightingPoint.Models.ControllerForm
import Shaders.LightingPoint.Models.DrawConfig.Main as Shaders.LightingPoint.Models.DrawConfig
import Shaders.LightingPoint.Models.Context.Main as Shaders.LightingPoint.Models.Context
import Shaders.LightingPoint.Main as Shaders.LightingPoint
  ...
  Effect.Aff.launchAff_ do
    result <- ExceptT.runExceptT $ do
      ...
      ExceptT.mapExceptT Effect.Class.liftEffect do
        ...
        context <- Shaders.LightingPoint.Models.Context.fromEnv
          { canvas: canvas
          }
        controller <- ExceptT.lift $ do
          angle <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.angle) input
          ...
          radius <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.radius) input
          ...
          count <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.count) input
          ...
          fieldOfView <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.fieldOfView) input
            Web.DOM.Element.setAttribute "step" (show 0.1) input
          ...
          x <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.position.x) input
          ...
          y <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.position.y) input
          ...
          z <- do
            ...
            Web.DOM.Element.setAttribute "value" (show $ Pages.Shaders.LightingPoint.Models.ControllerForm.unit.position.z) input
          ...
          scaleX <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.scale.x) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          scaleY <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ -2) input
            Web.DOM.Element.setAttribute "max" (show 2) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.scale.y) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          scaleZ <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ -2) input
            Web.DOM.Element.setAttribute "max" (show 2) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.scale.z) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
          ...
          rotationSpeedX <- do
            ...
            Web.DOM.Element.setAttribute "min" (show $ 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.rotationSpeed.x) input
          ...
          rotationSpeedY <- do
            ...
            Web.DOM.Element.setAttribute "min" (show 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.rotationSpeed.y) input
          ...
          rotationSpeedZ <- do
            ...
            Web.DOM.Element.setAttribute "min" (show 0) input
            Web.DOM.Element.setAttribute "max" (show 360) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.rotationSpeed.z) input
          ...
          pause <- do
            ...
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.pause) input
            Web.DOM.Element.setAttribute "step" (show 1) input
          ...
          lightY <- do
            ...
            Web.DOM.Element.setAttribute "max" (show 1) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.light.y) input
          ...
          lightZ <- do
            ...
            Web.DOM.Element.setAttribute "max" (show 1) input
            Web.DOM.Element.setAttribute "step" (show 0.01) input
            Web.DOM.Element.setAttribute "value" (show Pages.Shaders.LightingPoint.Models.ControllerForm.unit.light.z) input
          ...
          subscribe <- pure $ ContT.runContT $
            ( Lib.PubSub.concat
              ...
              ( Lib.PubSub.merge
                ...
                map Pages.Shaders.LightingPoint.Models.ControllerForm.fromMap #
            ...
            ( Lib.PubSub.fold
                ( \tx config ->
                  ( let d = Tuple.Nested.get1 tx
                    ...
                    in Pages.Shaders.LightingPoint.Models.ControllerForm.toDrawConfig d c config
                  )
                )
                Shaders.LightingPoint.Models.DrawConfig.unit
            )
          subscribe $ \config -> do
            result <- ExceptT.runExceptT $ Shaders.LightingPoint.main config context
