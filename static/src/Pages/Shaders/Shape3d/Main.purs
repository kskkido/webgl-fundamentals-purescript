module Pages.Shaders.Shape3d.Main where
...
import Shaders.Shape3d.Models.DrawConfig.Main as Shaders.Shape3d.Models.DrawConfig
import Shaders.Shape3d.Models.Context.Main as Shaders.Shape3d.Models.Context
import Shaders.Shape3d.Main as Shaders.Shape3d
  ...
  Effect.Aff.launchAff_ do
    result <- ExceptT.runExceptT $ do
      ...
      ExceptT.mapExceptT Effect.Class.liftEffect do
        ...
        context <- Shaders.Shape3d.Models.Context.fromEnv
          { canvas: canvas
          }
        ...
        ExceptT.lift $ do
          subscribe <- pure $ ContT.runContT
            ( Lib.PubSub.merge
              ...
              map Shaders.Shape3d.Models.DrawConfig.fromMap
            )
          subscribe $ \config -> do
            ...
            result <- ExceptT.runExceptT $ Shaders.Shape3d.main config context
