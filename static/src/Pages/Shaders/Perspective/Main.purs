module Pages.Shaders.Perspective.Main where
...
import Shaders.Perspective.Models.DrawConfig.Main as Shaders.Perspective.Models.DrawConfig
import Shaders.Perspective.Models.Context.Main as Shaders.Perspective.Models.Context
import Shaders.Perspective.Main as Shaders.Perspective
  ...
  Effect.Aff.launchAff_ do
    result <- ExceptT.runExceptT $ do
      ...
      ExceptT.mapExceptT Effect.Class.liftEffect do
        ...
        context <- Shaders.Perspective.Models.Context.fromEnv
          { canvas: canvas
          }
        ...
        ExceptT.lift $ do
          subscribe <- pure $ ContT.runContT
            ( Lib.PubSub.merge
              ...
              map Shaders.Perspective.Models.DrawConfig.fromMap
            )
          subscribe $ \config -> do
            ...
            result <- ExceptT.runExceptT $ Shaders.Perspective.main config context
