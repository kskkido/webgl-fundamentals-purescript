module Applications.Server.Templates.Pages.Shaders.LightingDirectional.Main
  ( render
  ) where
...
render = Lucid.doctypehtml_ do
  Lucid.head_ do
    Lucid.title_ "shaders/lighting-directional"
    Lucid.link_ [Lucid.rel_ "stylesheet", Lucid.href_ "/styles/index.css"]
    Lucid.script_ [Lucid.src_ "/scripts/pages/shaders/lighting-directional/index.js", Lucid.defer_ ""] ""
