module Applications.Server.Templates.Pages.Shaders.LightingPoint.Main
  ( render
  ) where
...
render = Lucid.doctypehtml_ do
  Lucid.head_ do
    Lucid.title_ "shaders/lighting-point"
    Lucid.link_ [Lucid.rel_ "stylesheet", Lucid.href_ "/styles/index.css"]
    Lucid.script_ [Lucid.src_ "/scripts/pages/shaders/lighting-point/index.js", Lucid.defer_ ""] ""
