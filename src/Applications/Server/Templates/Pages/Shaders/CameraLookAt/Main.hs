module Applications.Server.Templates.Pages.Shaders.CameraLookAt.Main
  ( render
  ) where
...
render = Lucid.doctypehtml_ do
  Lucid.head_ do
    Lucid.title_ "shaders/camera-look-at"
    Lucid.link_ [Lucid.rel_ "stylesheet", Lucid.href_ "/styles/index.css"]
    Lucid.script_ [Lucid.src_ "/scripts/pages/shaders/camera-look-at/index.js", Lucid.defer_ ""] ""
