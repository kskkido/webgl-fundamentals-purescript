module Applications.Server.Templates.Pages.Shaders.Texture2d.Main
  ( render
  ) where
...
render = Lucid.doctypehtml_ do
  Lucid.head_ do
    Lucid.title_ "shaders/texture2d"
    Lucid.link_ [Lucid.rel_ "stylesheet", Lucid.href_ "/styles/index.css"]
    Lucid.script_ [Lucid.src_ "/scripts/pages/shaders/texture2d/index.js", Lucid.defer_ ""] ""
