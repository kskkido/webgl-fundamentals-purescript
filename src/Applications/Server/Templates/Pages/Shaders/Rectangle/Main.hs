module Applications.Server.Templates.Pages.Shaders.Rectangle.Main
  ( render
  ) where
...
render = Lucid.doctypehtml_ do
  Lucid.head_ do
    Lucid.title_ "shaders/rectangle"
    Lucid.link_ [Lucid.rel_ "stylesheet", Lucid.href_ "/styles/index.css"]
    Lucid.script_ [Lucid.src_ "/scripts/pages/shaders/rectangle/index.js", Lucid.defer_ ""] ""
